...
def check(e):
    ...
    if typed == '':
        ...
        data = []
        for item in toppings:# para cada elemento de nuestra lista
...
for i in range(1,m_row+1):
    cell_obj = ws.cell(row=i, column=1)# Se obtiene el la celda por completp
    print(cell_obj.value)# se imprime el valor dentro de la celda
    toppings.append(cell_obj.value)# se agrega el valor a la lista toppings
...
my_entry.grid(row=0, column=0, padx=(10, 20), pady=(20, 0), sticky="ew")
